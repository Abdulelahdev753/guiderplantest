...
const labels = {
  ...
  formTitle: { en: "Book Your Trip", ar: "احجز رحلتك" },
  formDescription: {
    en: "Fill in your details and we'll get back to you.",
    ar: "أدخل بياناتك وسنتواصل معك.",
  },
...
export default function TravelAgencyCard({ agency, lang }: TravelAgencyCardProps) {
  ...
  return (
    <>
      <div className="rounded-2xl bg-white/[0.06] border border-white/[0.08] transition-[border-color] duration-300 hover:border-white/[0.15] hover:bg-white/[0.08]">
        <div className="p-6">
        ...
        <DialogContent keepMounted className="bg-neutral-950 border-white/[0.08] text-white max-w-md will-change-[transform,opacity] [-webkit-backface-visibility:hidden]">
          <DialogHeader>
            <DialogTitle className={`text-xl font-bold ${arFont}`}>
              ...
              {" — "}
              {labels.formTitle[lang]}
            </DialogTitle>
            <DialogDescription className="text-white/50">
              {labels.formDescription[lang]}
            </DialogDescription>
          </DialogHeader>
